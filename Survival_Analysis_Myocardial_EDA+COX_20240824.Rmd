...
cor(TRACE[,2:8])
```
# 3) KAPLAN-MEIER ESTIMATION FOR OVERALL SURVIVAL
...
## 3.10 Multiplot of All Kaplan-Meier Analyses
...
-> let's remove vf_truncated + wmi_truncated

### 4.8.4) CoxPH model of this truncated data - vf and wmi removed
```{r}
...
## 4.9) TimeCox model - other approach for analyzing time dependencies and transformations
